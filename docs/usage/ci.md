...
| `version` | `latest` | npm version of `repokernel`. Pin to a specific release (e.g. `1.29.0`) for reproducible CI. |
...
```bash
npm install -g repokernel@1.29.0

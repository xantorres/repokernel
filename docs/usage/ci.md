...
| `version` | `latest` | npm version of `repokernel`. Pin to a specific minor (e.g. `1.15.0`) for reproducible CI. |
...
```bash
npm install -g repokernel@1.15.0
